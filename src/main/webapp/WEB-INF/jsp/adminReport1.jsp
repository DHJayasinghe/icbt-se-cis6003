                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="${cp}/home/report1"><i class="fa fa-circle-o"></i> By Field of Study</a></li>
                                <li ><a href="${cp}/home/report2"><i class="fa fa-circle-o"></i> By Consultant</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Appointment Summary Report - By Field of Study</h3>
                ...
                var module={
                    getSummaryReport1: function(reportType, startDate, endDate){
                        ...
                        table = $('#tblAppointmentReport1').DataTable({
                            ...
                            buttons: [
                                {
                                    ...
                                    extend: 'excelHtml5',
                                    title: 'Appointment Summary Report - By Field of Study ('+ startDate +' - '+ endDate +')',
                                    titleAttr: 'Excel'
                                },
                                {
                            ...
                            "ajax": {
                                "url": "/educan.oas/admin/report/report1/"+ reportType +"/"+ startDate +"/"+endDate,
