...
public class ReportSummaryDAO {
    ...
    public List<AppointmentSummaryReport> appointmentReportByFieldofStudy(String reportType,String startDate,String endDate){
    ...
    public List<AppointmentSummaryReport> appointmentReportByConsultant(String reportType,String startDate,String endDate){
        List<AppointmentSummaryReport> result=new ArrayList<>();
        CallableStatement cstmt = null;
        ...
        try {
            ...
            cstmt = con.prepareCall("{call dbo.ProcGetAppointmentReport2(?,?,?)}");
            ...
            while(rs.next()){
                ...
                apt.setConsultantName(rs.getString("ConsultantName"));
                apt.setFieldName(rs.getString("FieldName"));
                apt.setAptCount(rs.getInt("AptCount"));
                apt.setYear(rs.getString("Year"));
                apt.setMonth(rs.getString("Month"));
