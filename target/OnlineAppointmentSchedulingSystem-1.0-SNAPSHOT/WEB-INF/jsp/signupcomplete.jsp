    ...
    <body class="hold-transition register-page">
        <div class="register-box">
            ...
            <div class="register-box-body">
                <p class="login-box-msg">You're almost complete setting up your account.</p>

                <form action="${cp}/student/signup/complete" method="post">
                    <input type="hidden" name="token"  value="${verificationtoken}">
                    <div class="form-group has-feedback">
                        <input type="password" name="password" class="form-control" placeholder="Password" maxlength="100" required="" autocomplete="off">
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">Please set up your password to secure your account.</div>
                    <div class="form-group has-feedback">
